      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="d-flex" action="search_product.php" method="get">
            ...
            <input type="submit" value="search" class="btn btn-outline-light" name="">
          </form>
        </div>
      </div>
    </nav>
    ...
    <div class="bg-light">
      ...
      <div class="d-flex justify-content-between mb-3">
        <form action="search_product.php" method="get">
          <input type="hidden" name="search_data_product" value="<?php echo urlencode($_GET['search_data_product']); ?>">
          <div class="btn-group">
            <button type="button" class="btn btn-secondary btn-sort">Sort by Price</button>
            <button type="button" class="btn btn-secondary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false">
              <span class="visually-hidden">Toggle Dropdown</span>
            </button>
            <ul class="dropdown-menu">
              <li><button type="submit" class="dropdown-item" name="sort_order" value="high_to_low">High to Low</button></li>
              <li><button type="submit" class="dropdown-item" name="sort_order" value="low_to_high">Low to High</button></li>
            </ul>
          </div>
        </form>
      </div>
